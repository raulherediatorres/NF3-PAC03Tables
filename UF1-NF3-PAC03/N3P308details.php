...
// Retrieve reviews for this movie and order them by date in ascending order
$query = 'SELECT
    ...
    WHERE
        review_movie_id = ' . $_GET['movie_id'] . '
    ORDER BY
        review_date ASC'; // Cambiamos 'DESC' a 'ASC' para ordenar por fecha ascendente
...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php?movie_id={$_GET['movie_id']}&sort=date">Date</a></th>
     <th style="width: 10em;"><a href="N3P308details.php?movie_id={$_GET['movie_id']}&sort=reviewer">Reviewer</a></th>
     <th><a href="N3P308details.php?movie_id={$_GET['movie_id']}&sort=comment">Comments</a></th>
     <th style="width: 5em;"><a href="N3P308details.php?movie_id={$_GET['movie_id']}&sort=rating">Rating</a></th>
    </tr>
ENDHTML;

// Initialize a variable to keep track of row numbers
$rowNumber = 0;
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $rowColor = $rowNumber % 2 == 0 ? '#e2e2e2' : '#ffffff';
